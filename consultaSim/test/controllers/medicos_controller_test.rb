...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference("Medico.count") do
      post medicos_url, params: { medico: { cpf: @medico.cpf, email: @medico.email, especialidade: @medico.especialidade, nomeCompleto: @medico.nomeCompleto, numeroCRM: @medico.numeroCRM } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { cpf: @medico.cpf, email: @medico.email, especialidade: @medico.especialidade, nomeCompleto: @medico.nomeCompleto, numeroCRM: @medico.numeroCRM } }
